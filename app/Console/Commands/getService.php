                    ...
                    if($data['category'] == "Games"){
                        ...
                        if(!$cekgame){
                          ...
                          $cekgame->update([
                             ...
                             'harga_member' => $data['price'] + ($data['price'] * $cekgame->profit / 100),
                             'harga_platinum' => $data['price'] + ($data['price'] * $cekgame->profit / 100),
                             'harga_gold' => $data['price'] + ($data['price'] * $cekgame->profit / 100),
                        ...
                        if(!$cekpulsa){
                            ...
                            $cekpulsa->update([
                             ...
                             'harga_member' => $data['price'] + ($data['price'] * $cekpulsa->profit / 100),
                             'harga_platinum' => $data['price'] + ($data['price'] * $cekpulsa->profit / 100),
                             'harga_gold' => $data['price'] + ($data['price'] * $cekpulsa->profit / 100),
                             'status' => ($data['seller_product_status'] === true ? "available" : "unavailable")
